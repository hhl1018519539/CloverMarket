		...
		<div class="modal-wrap">
			<div class="login-reg">
				...
				<div class="login">
					...
					<div class="else-login">其他登录&nbsp;
						<a href="#" class="qq"><img src="icon/qq-grey.png" /></a>&nbsp;
						<a href="#" class="wx"><img src="icon/wx-grey.png" /></a>
					</div>
				</div>
				<!--注册操作-->
				<div class="reg">
					<input type="text" required="required" name="username" id="username" placeholder="请输入邮箱或手机号" />
					 <input type="text" required="required" name="password"id="checkcode" placeholder="请输入密码" />
				<div class="protocol">
						<input type="checkbox" name="agree" id="agree" checked="checked" />
						<label for="agree">同意注册协议</label>
						<a href="pages/common/protocol.html" target="_blank">查看注册协议</a>
					</div>
	...
	<div class="qiaoYu">
		<div class="main">
			...
			<ul class="right clearFloat">
				<li>Hi,请 <a href="#" id="login">登录</a>&#47; <a href="#" id="reg">注册</a>
				</li>
				<li><a href="#">我的订单</a></li>
				<li><a href="#">充值中心</a></li>
